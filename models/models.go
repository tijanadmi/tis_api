...
type PiMMP struct {
	TIPD                         string `json:"-"`
	TIPDPR                       string `json:"-"`
	NAZTIPD                      string `json:"naziv_tipa_dogadjaja"`
	ID1_DDD                      string `json:"-"`
	TEKST                        string `json:"tekst"`
	OPIS                         string `json:"opis"`
	DATIZV                       string `json:"datum_izvestaja"`
	ID1_DD                       string `json:"-"`
	ID2_DD                       string `json:"-"`
	OB_ID                        string `json:"-"`
	OB_SIF_NAZ                   string `json:"objekat_sifra_naziv"`
	Ob_sif                       string `json:"objekat_sifra"`
	Nazob                        string `json:"naziv_objekta"`
	TIPOB                        string `json:"tip_objekta"`
	TRAFO_ID                     string `json:"-"`
	OB_ID2                       string `json:"-"`
	TIPOB2                       string `json:"tip_objekta2"`
	VREPOC                       string `json:"vreme_pocetka"`
	POC_PP                       string `json:"pocetak_posle_ponoci"`
	VREZAV                       string `json:"vreme_zavrsetka"`
	ZAV_PP                       string `json:"zavrsetak_posle_ponoci"`
	TRAJ                         string `json:"trajanje"`
	VRPD                         string `json:"vrsta_pogondkog_dogadjaja"`
	Nazvrpd                      string `json:"naziv_vrste_pogondkog_dogadjaja"`
	Vrem_usl                     string `json:"vremenski_uslovi"`
	GRUZR1                       string `json:"grupa_uzroka1"`
	UZROK1                       string `json:"uzrok1"`
	GRUZR2                       string `json:"grupa_uzroka2"`
	UZROK2                       string `json:"uzrok2"`
	VROPR                        string `json:"vrsta_opreme"`
	GRRAZ                        string `json:"grupa_razloga"`
	RAZLOG                       string `json:"razlog"`
	SNAGA                        string `json:"snaga"`
	NAPON                        string `json:"napon"`
	POLJE                        string `json:"polje"`
	IME_PO                       string `json:"ime_po"`
	FUNKC                        string `json:"-"`
	NAZSOP                       string `json:"naziv_sopstvena_potrosnja"`
	ID_S_SOP                     string `json:"-"`
	ID_SOP                       string `json:"-"`
	ID_TIPOB                     string `json:"-"`
	P2_traf_id                   string `json:"-"`
	SELEKTIVNOST_GL1             string `json:"selektivnost_gl1"`
	DIST_DIF_GL1                 string `json:"dist_dif_gl1"`
	KVAR_U_FAZI_GL1              string `json:"kvar_u_fazi_gl1"`
	RAD_APU_GL1                  string `json:"rad_apu_gl1"`
	PREKOSTRUJNA_GL1             string `json:"prekostrujna_gl1"`
	ZEMLJOSPOJNA_GL1             string `json:"zemljospojna_gl1"`
	USMERENA_ZEMLJOSPOJNA_GL1    string `json:"usmerena_zemljospojna_gl1"`
	TELEZASTITA_PRIJEM_GL1       string `json:"telezastita_prijem_gl1"`
	TELEZASTITA_SLANJE_GL1       string `json:"telezastita_slanje_gl1"`
	SELEKTIVNOST_GL2             string `json:"selektivnost_gl2"`
	DIST_DIF_GL2                 string `json:"dist_dif_gl2"`
	KVAR_U_FAZI_GL2              string `json:"kvar_u_fazi_gl2"`
	RAD_APU_GL2                  string `json:"rad_apu_gl2"`
	PREKOSTRUJNA_GL2             string `json:"prekostrujna_gl2"`
	ZEMLJOSPOJNA_GL2             string `json:"zemljospojna_gl2"`
	USMERENA_ZEMLJOSPOJNA_GL2    string `json:"usmerena_zemljospojna_gl2"`
	TELEZASTITA_PRIJEM_GL2       string `json:"telezastita_prijem_gl2"`
	TELEZASTITA_SLANJE_GL2       string `json:"telezastita_slanje_gl2"`
	SELEKTIVNOST_GL3             string `json:"selektivnost_gl3"`
	DIST_DIF_GL3                 string `json:"dist_dif_gl3"`
	KVAR_U_FAZI_GL3              string `json:"kvar_u_fazi_gl3"`
	RAD_APU_GL3                  string `json:"rad_apu_gl3"`
	PREKOSTRUJNA_GL3             string `json:"prekostrujna_gl3"`
	ZEMLJOSPOJNA_GL3             string `json:"zemljospojna_gl3"`
	USMERENA_ZEMLJOSPOJNA_GL3    string `json:"usmerena_zemljospojna_gl3"`
	TELEZASTITA_PRIJEM_GL3       string `json:"telezastita_prijem_gl3"`
	TELEZASTITA_SLANJE_GL3       string `json:"telezastita_slanje_gl3"`
	PREKIDAC_DV                  string `json:"prekidac_dv"`
	SELEKT_JPS_ZAS1_DV           string `json:"selekt_jps_zas1_dv"`
	SELEKT_JPS_ZAS2_DV           string `json:"selekt_jps_zas2_dv"`
	JPS_ZAS1_DV                  string `json:"jps_zas1_dv"`
	JPS_ZAS2_DV                  string `json:"jps_zas2_dv"`
	SELEKTIVNOST_TR_GL1          string `json:"selektivnost_tr_gl1"`
	DIST_DIF_TR_GL1              string `json:"dist_dif_tr_gl1"`
	KVAR_U_FAZI_TR_GL1           string `json:"kvar_u_fazi_tr_gl1"`
	PREKOSTRUJNA_TR_GL1          string `json:"prekostrujna_tr_gl1"`
	ZEMLJOSPOJNA_TR_GL1          string `json:"zemljospojna_tr_gl1"`
	SELEKTIVNOST_TR_GL2          string `json:"selektivnost_tr_gl2"`
	DIST_DIF_TR_GL2              string `json:"dist_dif_tr_gl2"`
	KVAR_U_FAZI_TR_GL2           string `json:"kvar_u_fazi_tr_gl2"`
	PREKOSTRUJNA_TR_GL2          string `json:"prekostrujna_tr_gl2"`
	ZEMLJOSPOJNA_TR_GL2          string `json:"zemljospojna_tr_gl2"`
	SELEKTIVNOST_TR_GL3          string `json:"selektivnost_tr_gl3"`
	DIST_DIF_TR_GL3              string `json:"dist_dif_tr_gl3"`
	KVAR_U_FAZI_TR_GL3           string `json:"kvar_u_fazi_tr_gl3"`
	PREKOSTRUJNA_TR_GL3          string `json:"prekostrujna_tr_gl3"`
	ZEMLJOSPOJNA_TR_GL3          string `json:"zemljospojna_tr_gl3"`
	JPS_ZAS_TR_VN                string `json:"jps_zas_tr_vn"`
	JPS_ZAS_TR_NN                string `json:"jps_zas_tr_nn"`
	JPS_ZAS_TR_VN2               string `json:"jps_zas_tr_vn2"`
	JPS_ZAS_TR_NN2               string `json:"jps_zas_tr_nn2"`
	JPS1_ZAS_SELEKTIVNOST        string `json:"jps1_zas_selektivnost"`
	JPS2_ZAS_SELEKTIVNOST        string `json:"jps2_zas_selektivnost"`
	SELEKT_TR_REZ                string `json:"selekt_tr_rez"`
	SELEKT_TR_REZ2               string `json:"selekt_tr_rez2"`
	DIST_DIF_TR_REZ              string `json:"dist_dif_tr_rez"`
	DIST_DIF_TR_REZ2             string `json:"dist_dif_tr_rez2"`
	KVAR_U_FAZI_TR_REZ           string `json:"kvar_u_fazi_tr_rez"`
	KVAR_U_FAZI_TR_REZ2          string `json:"kvar_u_fazi_tr_rez2"`
	PREKOSTRUJNA_TR_REZ          string `json:"prekostrujna_tr_rez"`
	PREKOSTRUJNA_TR_REZ2         string `json:"prekostrujna_tr_rez2"`
	ZEMLJOSPOJNA_TR_REZ          string `json:"zemljospojna_tr_rez"`
	ZEMLJOSPOJNA_TR_REZ2         string `json:"zemljospojna_tr_rez2"`
	TR_NEEL_1                    string `json:"tr_neel_1"`
	TR_NEEL_2                    string `json:"tr_neel_2"`
	TR_NEEL_3                    string `json:"tr_neel_3"`
	PREKIDAC_TR_VN               string `json:"prekidac_tr_vn"`
	PREKIDAC_TR_NN               string `json:"prekidac_tr_nn"`
	SELEKTIVNOST_SPP_GL2         string `json:"selektivnost_spp_gl2"`
	PREKOSTRUJNA_SPP_GL1         string `json:"prekostrujna_spp_gl1"`
	ZEMLJOSPOJNA_SPP_GL1         string `json:"zemljospojna_spp_gl1"`
	USMERENA_ZEMLJOSP_SPP_GL1    string `json:"usmerena_zemljosp_spp_gl1"`
	KVAR_U_FAZI_SPP_GL1          string `json:"kvar_u_fazi_spp_gl1"`
	DIST_DIF_SPP_GL1             string `json:"dist_dif_spp_gl1"`
	RAD_APU_SPP_GL1              string `json:"rad_apu_spp_gl1"`
	SELEKTIVNOST_SPP_GL2_DUP     string `json:"selektivnost_spp_gl2_dup"`
	PREKOSTRUJNA_SPP_GL2         string `json:"prekostrujna_spp_gl2"`
	ZEMLJOSPOJNA_SPP_GL2         string `json:"zemljospojna_spp_gl2"`
	USMERENA_ZEMLJOSP_SPP_GL2    string `json:"usmerena_zemljosp_spp_gl2"`
	KVAR_U_FAZI_SPP_GL2          string `json:"kvar_u_fazi_spp_gl2"`
	DIST_DIF_SPP_GL2             string `json:"dist_dif_spp_gl2"`
	RAD_APU_SPP_GL2              string `json:"rad_apu_spp_gl2"`
	PREKIDAC_SPP_VN              string `json:"prekidac_spp_vn"`
	JPS_ZAS_SPP_VN               string `json:"jps_zas_spp_vn"`
	JPS_ZAS_SPP_VN2              string `json:"jps_zas_spp_vn2"`
	JPS1_ZAS_SPP_SELEKT          string `json:"jps1_zas_spp_selekt"`
	JPS2_ZAS_SPP_SELEKT          string `json:"jps2_zas_spp_selekt"`
	SELEKTIVNOST_SAB_ZAS         string `json:"selektivnost_sab_zas"`
	SABIRNICKA_ZASTITA           string `json:"sabirnicka_zastita"`
	SABIRNICKA_ZASTITA2          string `json:"sabirnicka_zastita2"`
	SAB_ZAS_OTKAZ_PREK           string `json:"sab_zas_otkaz_prek"`
	SAB_ZAS_OTKAZ_PREK2          string `json:"sab_zas_otkaz_prek2"`
	KVAR_U_FAZI_SAB              string `json:"kvar_u_fazi_sab"`
	KVAR_U_FAZI_SAB2             string `json:"kvar_u_fazi_sab2"`
	SELEKTIVNOST_GL1_S2          string `json:"selektivnost_gl1_s2"`
	DIST_DIF_GL1_S2              string `json:"dist_dif_gl1_s2"`
	KVAR_U_FAZI_GL1_S2           string `json:"kvar_u_fazi_gl1_s2"`
	RAD_APU_GL1_S2               string `json:"rad_apu_gl1_s2"`
	PREKOSTRUJNA_GL1_S2          string `json:"prekostrujna_gl1_s2"`
	ZEMLJOSPOJNA_GL1_S2          string `json:"zemljospojna_gl1_s2"`
	USMERENA_ZEMLJOSPOJNA_GL1_S2 string `json:"usmerena_zemljospojna_gl1_s2"`
	TELEZASTITA_PRIJEM_GL1_S2    string `json:"telezastita_prijem_gl1_s2"`
	TELEZASTITA_SLANJE_GL1_S2    string `json:"telezastita_slanje_gl1_s2"`
	SELEKTIVNOST_GL2_S2          string `json:"selektivnost_gl2_s2"`
	DIST_DIF_GL2_S2              string `json:"dist_dif_gl2_s2"`
	KVAR_U_FAZI_GL2_S2           string `json:"kvar_u_fazi_gl2_s2"`
	RAD_APU_GL2_S2               string `json:"rad_apu_gl2_s2"`
	PREKOSTRUJNA_GL2_S2          string `json:"prekostrujna_gl2_s2"`
	ZEMLJOSPOJNA_GL2_S2          string `json:"zemljospojna_gl2_s2"`
	USMERENA_ZEMLJOSPOJNA_GL2_S2 string `json:"usmerena_zemljospojna_gl2_s2"`
	TELEZASTITA_PRIJEM_GL2_S2    string `json:"telezastita_prijem_gl2_s2"`
	TELEZASTITA_SLANJE_GL2_S2    string `json:"telezastita_slanje_gl2_s2"`
	SELEKTIVNOST_GL3_S2          string `json:"selektivnost_gl3_s2"`
	DIST_DIF_GL3_S2              string `json:"dist_dif_gl3_s2"`
	KVAR_U_FAZI_GL3_S2           string `json:"kvar_u_fazi_gl3_s2"`
	RAD_APU_GL3_S2               string `json:"rad_apu_gl3_s2"`
	PREKOSTRUJNA_GL3_S2          string `json:"prekostrujna_gl3_s2"`
	ZEMLJOSPOJNA_GL3_S2          string `json:"zemljospojna_gl3_s2"`
	USMERENA_ZEMLJOSPOJNA_GL3_S2 string `json:"usmerena_zemljospojna_gl3_s2"`
	TELEZASTITA_PRIJEM_GL3_S2    string `json:"telezastita_prijem_gl3_s2"`
	TELEZASTITA_SLANJE_GL3_S2    string `json:"telezastita_slanje_gl3_s2"`
	PREKIDAC_DV_S2               string `json:"prekidac_dv_s2"`
	SELEKTIVNOST_JPS_ZAS1_S2     string `json:"selektivnost_jps_zas1_s2"`
	SELEKTIVNOST_JPS_ZAS2_S2     string `json:"selektivnost_jps_zas2_s2"`
	JPS_ZAS1_DV_S2               string `json:"jps_zas1_dv_s2"`
	JPS_ZAS2_DV_S2               string `json:"jps_zas2_dv_s2"`
	SELEKTIVNOST_TR_GL1_S2       string `json:"selektivnost_tr_gl1_s2"`
	DIST_DIF_TR_GL1_S2           string `json:"dist_dif_tr_gl1_s2"`
	KVAR_U_FAZI_TR_GL1_S2        string `json:"kvar_u_fazi_tr_gl1_s2"`
	PREKOSTRUJNA_TR_GL1_S2       string `json:"prekostrujna_tr_gl1_s2"`
	ZEMLJOSPOJNA_TR_GL1_S2       string `json:"zemljospojna_tr_gl1_s2"`
	SELEKTIVNOST_TR_GL2_S2       string `json:"selektivnost_tr_gl2_s2"`
	DIST_DIF_TR_GL2_S2           string `json:"dist_dif_tr_gl2_s2"`
	KVAR_U_FAZI_TR_GL2_S2        string `json:"kvar_u_fazi_tr_gl2_s2"`
	PREKOSTRUJNA_TR_GL2_S2       string `json:"prekostrujna_tr_gl2_s2"`
	ZEMLJOSPOJNA_TR_GL2_S2       string `json:"zemljospojna_tr_gl2_s2"`
	SELEKTIVNOST_TR_GL3_S2       string `json:"selektivnost_tr_gl3_s2"`
	DIST_DIF_TR_GL3_S2           string `json:"dist_dif_tr_gl3_s2"`
	KVAR_U_FAZI_TR_GL3_S2        string `json:"kvar_u_fazi_tr_gl3_s2"`
	PREKOSTRUJNA_TR_GL3_S2       string `json:"prekostrujna_tr_gl3_s2"`
	ZEMLJOSPOJNA_TR_GL3_S2       string `json:"zemljospojna_tr_gl3_s2"`
	JPS_ZAS_TR_VN_S2             string `json:"jps_zas_tr_vn_s2"`
	JPS_ZAS_TR_NN_S2             string `json:"jps_zas_tr_nn_s2"`
	JPS_ZAS_TR_VN2_S2            string `json:"jps_zas_tr_vn2_s2"`
	JPS_ZAS_TR_NN2_S2            string `json:"jps_zas_tr_nn2_s2"`
	JPS1_ZAS_SELEKTIVNOST_S2     string `json:"jps1_zas_selektivnost_s2"`
	JPS2_ZAS_SELEKTIVNOST_S2     string `json:"jps2_zas_selektivnost_s2"`
	SELEKTIVNOST_TR_REZ_S2       string `json:"selektivnost_tr_rez_s2"`
	SELEKTIVNOST_TR_REZ2_S2      string `json:"selektivnost_tr_rez2_s2"`
	DIST_DIF_TR_REZ_S2           string `json:"dist_dif_tr_rez_s2"`
	DIST_DIF_TR_REZ2_S2          string `json:"dist_dif_tr_rez2_s2"`
	KVAR_U_FAZI_TR_REZ_S2        string `json:"kvar_u_fazi_tr_rez_s2"`
	KVAR_U_FAZI_TR_REZ2_S2       string `json:"kvar_u_fazi_tr_rez2_s2"`
	PREKOSTRUJNA_REZ_S2          string `json:"prekostrujna_rez_s2"`
	PREKOSTRUJNA_REZ2_S2         string `json:"prekostrujna_rez2_s2"`
	ZEMLJOSPOJNA_REZ_S2          string `json:"zemljospojna_rez_s2"`
	ZEMLJOSPOJNA_REZ2_S2         string `json:"zemljospojna_rez2_s2"`
	TR_NEEL_1_S2                 string `json:"tr_neel_1_s2"`
	TR_NEEL_2_S2                 string `json:"tr_neel_2_s2"`
	TR_NEEL_3_S2                 string `json:"tr_neel_3_s2"`
	PREKIDAC_TR_VN_S2            string `json:"prekidac_tr_vn_s2"`
	PREKIDAC_TR_NN_S2            string `json:"prekidac_tr_nn_s2"`
	SELEKTIVNOST_SPP_GL1_S2      string `json:"selektivnost_spp_gl1_s2"`
	PREKOSTRUJNA_SPP_GL1_S2_DUP  string `json:"prekostrujna_spp_gl1_s2_dup"`
	ZEMLJOSPOJNA_SPP_GL1_S2      string `json:"zemljospojna_spp_gl1_s2"`
	USMERENA_ZEMLJOSP_SPP_GL1_S2 string `json:"usmerena_zemljosp_spp_gl1_s2"`
	KVAR_U_FAZI_SPP_GL1_S2       string `json:"kvar_u_fazi_spp_gl1_s2"`
	DIST_DIF_SPP_GL1_S2          string `json:"dist_dif_spp_gl1_s2"`
	RAD_APU_SPP_GL1_S2           string `json:"rad_apu_spp_gl1_s2"`
	SELEKTIVNOST_SPP_GL2_S2      string `json:"selektivnost_spp_gl2_s2"`
	PREKOSTRUJNA_SPP_GL2_S2      string `json:"prekostrujna_spp_gl2_s2"`
	ZEMLJOSPOJNA_SPP_GL2_S2      string `json:"zemljospojna_spp_gl2_s2"`
	USMERENA_ZEMLJOSP_SPP_GL2_S2 string `json:"usmerena_zemljosp_spp_gl2_s2"`
	KVAR_U_FAZI_SPP_GL2_S2       string `json:"kvar_u_fazi_spp_gl2_s2"`
	DIST_DIF_SPP_GL2_S2          string `json:"dist_dif_spp_gl2_s2"`
	RAD_APU_SPP_GL2_S2           string `json:"rad_apu_spp_gl2_s2"`
	PREKIDAC_SPP_VN_S2           string `json:"prekidac_spp_vn_s2"`
	JPS_ZAS_SPP_VN_S2            string `json:"jps_zas_spp_vn_s2"`
	JPS_ZAS_SPP_VN2_S2           string `json:"jps_zas_spp_vn2_s2"`
	JPS1_ZAS_SPP_SELEKT_S2       string `json:"jps1_zas_spp_selekt_s2"`
	JPS2_ZAS_SPP_SELEKT_S2       string `json:"jps2_zas_spp_selekt_s2"`
	SELEKTIVNOST_SAB_ZAS_S2      string `json:"selektivnost_sab_zas_s2"`
	SABIRNICKA_ZASTITA_S2        string `json:"sabirnicka_zastita_s2"`
	SABIRNICKA_ZASTITA2_S2       string `json:"sabirnicka_zastita2_s2"`
	SAB_ZAS_OTKAZ_PREK_S2        string `json:"sab_zas_otkaz_prek_s2"`
	SAB_ZAS_OTKAZ_PREK2_S2       string `json:"sab_zas_otkaz_prek2_s2"`
	KVAR_U_FAZI_SAB_S2           string `json:"kvar_u_fazi_sab_s2"`
	KVAR_U_FAZI_SAB2_S2          string `json:"kvar_u_fazi_sab2_s2"`
	LOKATOR_KVARA_1_DV           string `json:"lokator_kvara_1_dv_u_km"`
	LOKATOR_KVARA_2_DV           string `json:"lokator_kvara_2_dv_u_km"`
	LOKATOR_KVARA_3_DV           string `json:"lokator_kvara_3_dv_u_km"`
	LOKATOR_KVARA_1_DV_S2        string `json:"lokator_kvara_1_dv_s2_u_km"`
	LOKATOR_KVARA_2_DV_S2        string `json:"lokator_kvara_2_dv_s2_u_km"`
	LOKATOR_KVARA_3_DV_S2        string `json:"lokator_kvara_3_dv_s2_u_km"`
	LOKATOR_KVARA_1_SPP          string `json:"lokator_kvara_1_spp_u_km"`
	LOKATOR_KVARA_2_SPP          string `json:"lokator_kvara_2_spp_u_km"`
	LOKATOR_KVARA_1_SPP_S2       string `json:"lokator_kvara_1_spp_s2_u_km"`
	LOKATOR_KVARA_2_SPP_S2       string `json:"lokator_kvara_2_spp_s2_u_km"`
	IPS_ID_OB                    string `json:"ips_id_objekta"`
	STATUS_OB                    string `json:"status_objekta"`
	IPS_ID_OB_A                  string `json:"ips_id_objekta_a"`
	IPS_ID_OB_B                  string `json:"ips_id_objekta_b"`
	EMS_KPS                      string `json:"ems_kps"`
	DIS_GL1_IPS_ID               string `json:"dis_gl1_ips_id"`
	DIS_GL2_IPS_ID               string `json:"dis_gl2_ips_id"`
	DIS_GL3_IPS_ID               string `json:"dis_gl3_ips_id"`
	DIF_GL1_IPS_ID               string `json:"dif_gl1_ips_id"`
	DIF_GL2_IPS_ID               string `json:"dif_gl2_ips_id"`
	DIF_GL3_IPS_ID               string `json:"dif_gl3_ips_id"`
	APU_GL1_IPS_ID               string `json:"apu_gl1_ips_id"`
	APU_GL2_IPS_ID               string `json:"apu_gl2_ips_id"`
	APU_GL3_IPS_ID               string `json:"apu_gl3_ips_id"`
	DIF_TR_GL1_IPS_ID            string `json:"dif_tr_gl1_ips_id"`
	DIF_TR_GL2_IPS_ID            string `json:"dif_tr_gl2_ips_id"`
